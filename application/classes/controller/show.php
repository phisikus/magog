...
class Controller_Show extends Controller_Main
{
    ...
    public function action_index()
    {
        ...
        if (isset($id)) {
            ...
            elseif ($id == 0)
                $this->request->redirect('index.php/show/news'); elseif ($id > 0)
                $this->request->redirect('index.php/show/page/' . $id);
        }
    }
    ...
    public function action_page()
    {
        ...
        if (!empty($id)) {
            ...
            // Add comment, check time of previous comment (anti-spam)
            $commentSpam = false;
