...
<table>
    ...
    if (isset($page->id)) {
        echo '<tr><td class="col">' . __('Szkic') . '</td><td class="createDraft" id="createDraft"><span><input type="checkbox" name="createDraft" value="1" /> ' . __('Zapisz jako szkic') . ' <span>('.__('Zalecane').')</span></span></td></tr>';
    }
